          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-14">
            ...
            <div className="md:col-span-5">
              <div className="flex items-center gap-2 mb-4">
                <span className="text-xl font-extrabold tracking-tighter font-headline text-white">RIBRIZ</span>
              ...
              <p className="text-sm leading-relaxed mb-6 max-w-xs" style={{ color: "rgba(255,255,255,0.38)" }}>
                University matching, admission prediction, and SOP generation — all without an agent. Built for Indian students going abroad.
              </p>
              {/* Email pill */}
              <a
            ...
            <div className="md:col-span-7 grid grid-cols-3 gap-8">
              ...
              <div>
                <h4 className="text-[10px] font-bold uppercase tracking-widest mb-5" style={{ color: "rgba(255,255,255,0.25)" }}>Account</h4>
                <ul className="space-y-3.5">
                  {[
              ...
              <div>
                <h4 className="text-[10px] font-bold uppercase tracking-widest mb-5" style={{ color: "rgba(255,255,255,0.25)" }}>Destinations</h4>
                <ul className="space-y-3.5">
                  {["Canada", "Germany", "Australia", "UK", "Singapore", "USA"].map((c) => (
                    <li key={c}>
                      <a
                        href="#"
                        className="text-sm transition-colors"
